...
<body>
    ...
    <div class="our_price_section layout_padding about_main">
        <div class="container">
            <h1 class="our_price"><strong>OUR PLAN</strong></h1>
            <p class="client_long_text">Chosse Your Best Plan Here...</p>
            <div class="price_section_2">
                <div class="row">
                   <?php
                    include('db.php');
                    
                          $sql=mysqli_query($cnn,"select * from plan");
                    ...
                    <div class="col-sm-12 col-lg-4">
                        ...
                        <div class="beginner">
                            <h2 class="beginner_text"><?php echo $row['pid'];?></h2>
                            <h1 class="plan_text"><?php echo $row['planName'];?></h1>
                            <P class="access_text"><?php echo $row['description'];?></P>
                            <P class="access_text">Validity :- <?php echo $row['validity'];?> Month</P>
                            <P class="access_text"><?php echo $row['amount'];?>Rs</P>
                           
                        </div>
                        <div class="select_boton">
                            <div class="select_bt"><a href="contact.php">SELECT PLAN</a></div>
                        </div>
